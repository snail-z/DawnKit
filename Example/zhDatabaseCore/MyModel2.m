...
- (void)writeInfos {
    ...
    for (NSInteger i = 0; i < 5; i++) {
        ...
        [self zh_saveValues:values];
    }
}

- (void)selectInfos {
    NSArray *array1 = [self zh_ascendingSelectOrderKey:@"zID"
                                            limitCount:3
                                  byCriteriaWithFormat:nil];
    NSLog(@"array1 : %@", array1);
    
    
    NSArray *array2 = [self zh_descendingSelectOrderKey:@"zID"
                                             limitCount:3
...
- (NSString *)zh_tableName {
    return @"MyModel2_table";
}

- (NSString *)zh_databaseName {
    return @"example2.sqlite";
}

- (NSString *)zh_columnDescription {
    return @""
